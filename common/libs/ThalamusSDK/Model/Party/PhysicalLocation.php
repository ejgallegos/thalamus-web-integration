 ...
 * @package ThalamusSDK
 */
class PhysicalLocation extends ThalamusModel {
	...
	/**
	 * 
	 * @return \ThalamusSDK\Model\Party\Profile|Boolean
	 */
	...
	public function changePassword($oldPassword, String $newPassword, String $confirmNewPassword) {
	    ...
	    $r = ThalamusRequest::put ( "/physicallocation/passwordchange?oldPasswordRequired=$oldPasswordRequired", $params )->auth($session->getRealUser(), $session->getAccessToken())->execute ();
	...
	public function update(Array $profile = null, Array $optIns = null, Array $consumers = null) {
		...
		return ThalamusRequest::put ( '/physicallocation', $params )->execute ();
	}
